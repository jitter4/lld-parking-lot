...
public class ParkingLotTests {
    ...
    @Test
    void isCarWithRegistrationNumberParked_True() {
        ParkingLot parkingLot = new ParkingLot(1);
        parkingLot.reserveSlot(new Car("DummyRegNo", "RED"));
        assertTrue(parkingLot.isCarWithRegistrationNumberParked("DummyRegNo"));
    }

    @Test
    void isCarWithRegistrationNumberParked_False() {
        ParkingLot parkingLot = new ParkingLot(1);
        parkingLot.reserveSlot(new Car("DummyRegNo", "RED"));
        assertFalse(parkingLot.isCarWithRegistrationNumberParked("DummyRegNo2"));
    }
}
